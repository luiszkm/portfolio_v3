...
export function Skills({mobile}: Props ) {


  return mobile? (
    <div
      className="md:h-[424px] md:hidden w-full flex items-center justify-center rounded-2xl p-1 md:mt-14 bg-gradient-to-br 
    ...
    <div
    className="md:h-[424px] w-full hidden md:flex items-center justify-center rounded-2xl p-1 md:mt-14 bg-gradient-to-br 
  from-purple-800 via-Fuchsia-800 to-pink-700"
  >
    <section
      className=" h-full w-full rounded-2xl p-4 
