...
export function About() {
  ...
  return (
    <div className="md:h-[424px] w-full flex items-center justify-center rounded-2xl p-2 md:mt-14 bg-gradient-to-br from-purple-800 via-Fuchsia-800 to-pink-700">
